...
def testMaxArea():
    arglist = []
    arglist.append({'height':[1, 1], 'answer':1})
    arglist.append({'height':[2, 1], 'answer':1})
    arglist.append({'height':[1,234,788,1312,843,66,985,323,1], 'answer':3152})
    for arg in arglist:
        print('expected:',arg['answer'], 'output:', maxArea(arg['height']))
